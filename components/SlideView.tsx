...
export default function SlideView({ celebrity, photoBaseUrl, showFact, colorMode }: SlideViewProps) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-1 py-2 md:px-4 md:py-4">
      <div className="w-full max-w-none md:max-w-2xl">
        <div className="photo-matte relative overflow-hidden" style={{ maxHeight: "calc(100vh - 80px)" }}>
